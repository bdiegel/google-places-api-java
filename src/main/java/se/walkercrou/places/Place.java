...
public class Place {
    ...
    public static Place parseDetails(GooglePlaces client, String rawJson) {
        ...
        return place.setClient(client).setId(id).setName(name).setAddress(address).setIconUrl(iconUrl).setPrice(price)
                ...
                .setUtcOffset(utcOffset).setJson(result).setPlaceId(placeId);
    }
    ...
    /**
     * Returns the unique id for retrieving information about this place.
     *
     * @return placeId
     */
    ...
    /**
     * Sets the unique id for retrieving information about this place.
     *
